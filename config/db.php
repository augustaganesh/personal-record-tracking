...
class Database
{
    ...
    {
        // $this->_connection = new PDO('mysql:host=sql206.epizy.com;dbname=epiz_30107172_db_my_records', 'epiz_30107172', 'E2zSX6ae2jXoicd');
        // $this->_connection = new PDO('mysql:host=sql206.epizy.com;dbname=epiz_30107172_db_my_records', 'epiz_30107172', 'E2zSX6ae2jXoicd');


          $this->_connection = new PDO('mysql:host=127.0.0.1;dbname=myrecords', 'root', '');
